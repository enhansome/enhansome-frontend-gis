...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,650 | 🐛 581 | 🌐 JavaScript | 📅 2026-09-21 - The leading open-source JavaScript library for mobile-friendly interactive maps. ![GitHub stars](https://img.shields.io/github/stars/Leaflet/Leaflet?style=social)
* [Cesium.js](https://github.com/CesiumGS/cesium) ⭐ 15,763 | 🐛 1,664 | 🌐 JavaScript | 📅 2026-09-21 - An open-source JavaScript library for world-class 3D mapping of geospatial data. ![GitHub stars](https://img.shields.io/github/stars/CesiumGS/cesium?style=social)
* [Deck.GL](https://github.com/visgl/deck.gl) ⭐ 14,603 | 🐛 536 | 🌐 TypeScript | 📅 2026-09-22 - WebGL2 powered geospatial visualization layers. ![GitHub stars](https://img.shields.io/github/stars/visgl/deck.gl?style=social)
* [OpenLayers](https://github.com/openlayers/openlayers) ⭐ 12,586 | 🐛 851 | 🌐 JavaScript | 📅 2026-09-19 - A high-performance, feature-packed library for creating interactive maps on the web. ![GitHub stars](https://img.shields.io/github/stars/openlayers/openlayers?style=social)
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,415 | 🐛 1,455 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript library that uses WebGL to render interactive maps from vector tiles. ![GitHub stars](https://img.shields.io/github/stars/mapbox/mapbox-gl-js?style=social)
* [maplibre](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,720 | 🐛 290 | 🌐 TypeScript | 📅 2026-09-22 - It originated as an open-source fork of mapbox-gl-js, before their switch to a non-OSS license in December 2020. ![GitHub stars](https://img.shields.io/github/stars/maplibre/maplibre-gl-js?style=social)
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,355 | 🐛 171 | 🌐 TypeScript | 📅 2026-09-12 - An SVG mapping component library for React, built on top of d3-geo. ![GitHub stars](https://img.shields.io/github/stars/zcreativelabs/react-simple-maps?style=social)
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,179 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering. ![GitHub stars](https://img.shields.io/github/stars/vasturiano/globe.gl?style=social)
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,365 | 🐛 883 | 🌐 TypeScript | 📅 2026-09-22 - A library for building rich, web-based geospatial data explorers. ![GitHub stars](https://img.shields.io/github/stars/TerriaJS/terriajs?style=social)
...
* [gridviz](https://github.com/eurostat/gridviz) ⭐ 245 | 🐛 20 | 🌐 JavaScript | 📅 2026-05-08 - A package for visualizing gridded data. ![GitHub stars](https://img.shields.io/github/stars/eurostat/gridviz?style=social)
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,492 | 🐛 289 | 🌐 TypeScript | 📅 2026-09-07 - A JavaScript library for spatial analysis. ![GitHub stars](https://img.shields.io/github/stars/Turfjs/turf?style=social)
...
* [awesome-GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,541 | 🐛 1 | 📅 2026-09-01 - Catalogue of GeoJSON tools. ![GitHub stars](https://img.shields.io/github/stars/tmcw/awesome-geojson?style=social)
...
* [geoparquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,092 | 🐛 51 | 🌐 Python | 📅 2026-09-21 - Encoding geospatial data in Apache Parquet. ![GitHub stars](https://img.shields.io/github/stars/opengeospatial/geoparquet?style=social)
...
* [EOSDIS Worldview](https://github.com/nasa-gibs/worldview) ⭐ 1,871 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-21 - Interactive interface for browsing global, full-resolution satellite imagery. ![GitHub stars](https://img.shields.io/github/stars/nasa-gibs/worldview?style=social)
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 468 | 🐛 14 | 🌐 Python | 📅 2026-09-14 - Retrieve live airspace information. ![GitHub stars](https://img.shields.io/github/stars/openskynetwork/opensky-api?style=social)
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,099 | 🐛 160 | 📅 2026-09-21 - An awesome repository full of open datasets from an abundance of different categories.  ![GitHub stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets?style=social)
* [Public APIs](https://github.com/public-apis-dev/public-apis) ⭐ 9,488 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-22 - A collective list of free APIs for use in software and web development. ![GitHub stars](https://img.shields.io/github/stars/public-apis-dev/public-apis?style=social)
...
* [GeoLibre](https://github.com/opengeos/GeoLibre) ⭐ 7,573 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-22 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data across desktop and web environments, with a responsive layout for mobile screens. ![GitHub stars](https://img.shields.io/github/stars/opengeos/GeoLibre?style=social)
* [Fantasy Map Generator](https://github.com/Azgaar/Fantasy-Map-Generator) ⭐ 6,017 | 🐛 85 | 🌐 HTML | 📅 2026-09-22 - Free web application for creating and editing fantasy maps. ![GitHub stars](https://img.shields.io/github/stars/Azgaar/Fantasy-Map-Generator?style=social)
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,638 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-21 - Free and open visual editor for Mapbox GL styles. ![GitHub stars](https://img.shields.io/github/stars/maputnik/editor?style=social)
* [uMap](https://github.com/umap-project/umap) ⭐ 1,602 | 🐛 385 | 🌐 JavaScript | 📅 2026-09-22 - Create maps with OpenStreetMap layers and embed them in your site. ![GitHub stars](https://img.shields.io/github/stars/umap-project/umap?style=social)
...
If you have any questions about this list, please don't hesitate to contact me [@joewdavies](https://twitter.com/joewdavies) on X (formerly Twitter) or [open a GitHub issue](https://github.com/joewdavies/awesome-frontend-gis/issues/new) ⭐ 861 | 🐛 9 | 📅 2026-08-18.
