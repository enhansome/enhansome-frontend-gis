...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,627 | 🐛 577 | 🌐 JavaScript | 📅 2026-09-14 - The leading open-source JavaScript library for mobile-friendly interactive maps. ![GitHub stars](https://img.shields.io/github/stars/Leaflet/Leaflet?style=social)
* [Cesium.js](https://github.com/CesiumGS/cesium) ⭐ 15,746 | 🐛 1,654 | 🌐 JavaScript | 📅 2026-09-16 - An open-source JavaScript library for world-class 3D mapping of geospatial data. ![GitHub stars](https://img.shields.io/github/stars/CesiumGS/cesium?style=social)
* [Deck.GL](https://github.com/visgl/deck.gl) ⭐ 14,596 | 🐛 538 | 🌐 TypeScript | 📅 2026-09-17 - WebGL2 powered geospatial visualization layers. ![GitHub stars](https://img.shields.io/github/stars/visgl/deck.gl?style=social)
* [OpenLayers](https://github.com/openlayers/openlayers) ⭐ 12,576 | 🐛 851 | 🌐 JavaScript | 📅 2026-09-16 - A high-performance, feature-packed library for creating interactive maps on the web. ![GitHub stars](https://img.shields.io/github/stars/openlayers/openlayers?style=social)
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,405 | 🐛 1,455 | 🌐 TypeScript | 📅 2026-09-17 - JavaScript library that uses WebGL to render interactive maps from vector tiles. ![GitHub stars](https://img.shields.io/github/stars/mapbox/mapbox-gl-js?style=social)
* [maplibre](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,674 | 🐛 271 | 🌐 TypeScript | 📅 2026-09-17 - It originated as an open-source fork of mapbox-gl-js, before their switch to a non-OSS license in December 2020. ![GitHub stars](https://img.shields.io/github/stars/maplibre/maplibre-gl-js?style=social)
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,535 | 🐛 121 | 🌐 HTML | 📅 2026-09-14 - An open-source JavaScript library for integrated 2D/3D maps. ![GitHub stars](https://img.shields.io/github/stars/maptalks/maptalks.js?style=social)
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,174 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering. ![GitHub stars](https://img.shields.io/github/stars/vasturiano/globe.gl?style=social)
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,365 | 🐛 887 | 🌐 TypeScript | 📅 2026-09-17 - A library for building rich, web-based geospatial data explorers. ![GitHub stars](https://img.shields.io/github/stars/TerriaJS/terriajs?style=social)
* [iTowns](https://github.com/iTowns/itowns) ⭐ 1,271 | 🐛 293 | 🌐 JavaScript | 📅 2026-09-14 - A Three.js-based framework written in JavaScript/WebGL for visualizing 3D geospatial data. ![GitHub stars](https://img.shields.io/github/stars/iTowns/itowns?style=social)
...
* [Eurostat-map](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-16 - Data-driven maps. ![GitHub stars](https://img.shields.io/github/stars/eurostat/eurostat-map.js?style=social)
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,488 | 🐛 288 | 🌐 TypeScript | 📅 2026-09-07 - A JavaScript library for spatial analysis. ![GitHub stars](https://img.shields.io/github/stars/Turfjs/turf?style=social)
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,778 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing. ![GitHub stars](https://img.shields.io/github/stars/mourner/rbush?style=social)
* [awesome-GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,540 | 🐛 0 | 📅 2026-09-01 - Catalogue of GeoJSON tools. ![GitHub stars](https://img.shields.io/github/stars/tmcw/awesome-geojson?style=social)
* [Proj4js](https://github.com/proj4js/proj4js) ⭐ 2,242 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-13 - Transform coordinates from one coordinate system to another. ![GitHub stars](https://img.shields.io/github/stars/proj4js/proj4js?style=social)
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,077 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data. ![GitHub stars](https://img.shields.io/github/stars/mapbox/geojson-vt?style=social)
...
* [geoparquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,089 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - Encoding geospatial data in Apache Parquet. ![GitHub stars](https://img.shields.io/github/stars/opengeospatial/geoparquet?style=social)
* [GeoTiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,051 | 🐛 89 | 🌐 JavaScript | 📅 2026-09-13 - Parse TIFF files for visualization or analysis. ![GitHub stars](https://img.shields.io/github/stars/geotiffjs/geotiff.js?style=social)
...
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 824 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers. ![GitHub stars](https://img.shields.io/github/stars/flatgeobuf/flatgeobuf?style=social)
...
* [gdal3.js](https://github.com/bugra9/gdal3.js) ⭐ 433 | 🐛 29 | 🌐 JavaScript | 📅 2026-05-13 - Convert raster and vector geospatial data to various formats. ![GitHub stars](https://img.shields.io/github/stars/bugra9/gdal3.js?style=social)
...
* [geoblaze](https://github.com/GeoTIFF/geoblaze) ⭐ 191 | 🐛 54 | 🌐 JavaScript | 📅 2024-08-05 - A blazing fast JavaScript raster processing engine. ![GitHub stars](https://img.shields.io/github/stars/GeoTIFF/geoblaze?style=social)
...
* [Potree](https://github.com/potree/potree) ⭐ 5,612 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets. ![GitHub stars](https://img.shields.io/github/stars/potree/potree?style=social)
...
* [EOSDIS Worldview](https://github.com/nasa-gibs/worldview) ⭐ 1,865 | 🐛 23 | 🌐 JavaScript | 📅 2026-09-16 - Interactive interface for browsing global, full-resolution satellite imagery. ![GitHub stars](https://img.shields.io/github/stars/nasa-gibs/worldview?style=social)
* [Spectral](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,179 | 🐛 23 | 🌐 Python | 📅 2026-09-13 - Awesome Spectral Indices for the Google Earth Engine JavaScript API. ![GitHub stars](https://img.shields.io/github/stars/awesome-spectral-indices/awesome-spectral-indices?style=social)
...
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 319 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics. ![GitHub stars](https://img.shields.io/github/stars/teamookla/ookla-open-data?style=social)
...
* [ZipCheckup API](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-09-16 - Free REST API for US ZIP-level environmental safety data: water quality, air quality, PFAS, radon, lead, flood risk. ![GitHub stars](https://img.shields.io/github/stars/artakulov/us-water-quality-data?style=social)
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 79,000 | 🐛 158 | 📅 2026-09-16 - An awesome repository full of open datasets from an abundance of different categories.  ![GitHub stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets?style=social)
* [Public APIs](https://github.com/public-apis-dev/public-apis) ⭐ 9,472 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-17 - A collective list of free APIs for use in software and web development. ![GitHub stars](https://img.shields.io/github/stars/public-apis-dev/public-apis?style=social)
...
* [GeoLibre](https://github.com/opengeos/GeoLibre) ⭐ 7,600 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-17 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data across desktop and web environments, with a responsive layout for mobile screens. ![GitHub stars](https://img.shields.io/github/stars/opengeos/GeoLibre?style=social)
* [Fantasy Map Generator](https://github.com/Azgaar/Fantasy-Map-Generator) ⭐ 6,002 | 🐛 81 | 🌐 HTML | 📅 2026-09-17 - Free web application for creating and editing fantasy maps. ![GitHub stars](https://img.shields.io/github/stars/Azgaar/Fantasy-Map-Generator?style=social)
* [mapus](https://github.com/alyssaxuu/mapus) ⭐ 3,536 | 🐛 9 | 🌐 JavaScript | 📅 2022-07-02 - Tool for collaboratively exploring and annotating maps. ![GitHub stars](https://img.shields.io/github/stars/alyssaxuu/mapus?style=social)
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,633 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-17 - Free and open visual editor for Mapbox GL styles. ![GitHub stars](https://img.shields.io/github/stars/maputnik/editor?style=social)
* [uMap](https://github.com/umap-project/umap) ⭐ 1,599 | 🐛 387 | 🌐 JavaScript | 📅 2026-09-15 - Create maps with OpenStreetMap layers and embed them in your site. ![GitHub stars](https://img.shields.io/github/stars/umap-project/umap?style=social)
...
If you have any questions about this list, please don't hesitate to contact me [@joewdavies](https://twitter.com/joewdavies) on X (formerly Twitter) or [open a GitHub issue](https://github.com/joewdavies/awesome-frontend-gis/issues/new) ⭐ 860 | 🐛 8 | 📅 2026-08-18.
