...
* [Leaflet](https://github.com/Leaflet/Leaflet) ⭐ 45,591 | 🐛 568 | 🌐 JavaScript | 📅 2026-09-07 - The leading open-source JavaScript library for mobile-friendly interactive maps. ![GitHub stars](https://img.shields.io/github/stars/Leaflet/Leaflet?style=social)
* [Cesium.js](https://github.com/CesiumGS/cesium) ⭐ 15,694 | 🐛 1,662 | 🌐 JavaScript | 📅 2026-09-09 - An open-source JavaScript library for world-class 3D mapping of geospatial data. ![GitHub stars](https://img.shields.io/github/stars/CesiumGS/cesium?style=social)
* [Deck.GL](https://github.com/visgl/deck.gl) ⭐ 14,569 | 🐛 514 | 🌐 TypeScript | 📅 2026-09-09 - WebGL2 powered geospatial visualization layers. ![GitHub stars](https://img.shields.io/github/stars/visgl/deck.gl?style=social)
* [OpenLayers](https://github.com/openlayers/openlayers) ⭐ 12,570 | 🐛 856 | 🌐 JavaScript | 📅 2026-09-08 - A high-performance, feature-packed library for creating interactive maps on the web. ![GitHub stars](https://img.shields.io/github/stars/openlayers/openlayers?style=social)
* [Mapbox GL JS](https://github.com/mapbox/mapbox-gl-js) ⭐ 12,404 | 🐛 1,458 | 🌐 TypeScript | 📅 2026-09-09 - JavaScript library that uses WebGL to render interactive maps from vector tiles. ![GitHub stars](https://img.shields.io/github/stars/mapbox/mapbox-gl-js?style=social)
* [maplibre](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,580 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-09 - It originated as an open-source fork of mapbox-gl-js, before their switch to a non-OSS license in December 2020. ![GitHub stars](https://img.shields.io/github/stars/maplibre/maplibre-gl-js?style=social)
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,535 | 🐛 118 | 🌐 HTML | 📅 2026-08-25 - An open-source JavaScript library for integrated 2D/3D maps. ![GitHub stars](https://img.shields.io/github/stars/maptalks/maptalks.js?style=social)
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,307 | 🐛 180 | 🌐 TypeScript | 📅 2026-09-09 - An SVG mapping component library for React, built on top of d3-geo. ![GitHub stars](https://img.shields.io/github/stars/zcreativelabs/react-simple-maps?style=social)
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-09 - A library for building rich, web-based geospatial data explorers. ![GitHub stars](https://img.shields.io/github/stars/TerriaJS/terriajs?style=social)
...
* [Eurostat-map](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-25 - Data-driven maps. ![GitHub stars](https://img.shields.io/github/stars/eurostat/eurostat-map.js?style=social)
...
* [Turf.js](https://github.com/Turfjs/turf) ⭐ 10,474 | 🐛 285 | 🌐 TypeScript | 📅 2026-09-07 - A JavaScript library for spatial analysis. ![GitHub stars](https://img.shields.io/github/stars/Turfjs/turf?style=social)
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,773 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing. ![GitHub stars](https://img.shields.io/github/stars/mourner/rbush?style=social)
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,044 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data. ![GitHub stars](https://img.shields.io/github/stars/mapbox/geojson-vt?style=social)
* [flatbush](https://github.com/mourner/flatbush) ⭐ 1,599 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-08 - A really fast static spatial index for 2D points and rectangles in JavaScript. ![GitHub stars](https://img.shields.io/github/stars/mourner/flatbush?style=social)
...
* [GeoTiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,046 | 🐛 95 | 🌐 JavaScript | 📅 2026-05-26 - Parse TIFF files for visualization or analysis. ![GitHub stars](https://img.shields.io/github/stars/geotiffjs/geotiff.js?style=social)
...
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 820 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers. ![GitHub stars](https://img.shields.io/github/stars/flatgeobuf/flatgeobuf?style=social)
...
* [Potree](https://github.com/potree/potree) ⭐ 5,599 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - WebGL point cloud viewer for large datasets. ![GitHub stars](https://img.shields.io/github/stars/potree/potree?style=social)
...
* [EOSDIS Worldview](https://github.com/nasa-gibs/worldview) ⭐ 1,854 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-04 - Interactive interface for browsing global, full-resolution satellite imagery. ![GitHub stars](https://img.shields.io/github/stars/nasa-gibs/worldview?style=social)
* [Spectral](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,172 | 🐛 23 | 🌐 Python | 📅 2026-09-06 - Awesome Spectral Indices for the Google Earth Engine JavaScript API. ![GitHub stars](https://img.shields.io/github/stars/awesome-spectral-indices/awesome-spectral-indices?style=social)
...
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 316 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics. ![GitHub stars](https://img.shields.io/github/stars/teamookla/ookla-open-data?style=social)
...
* [awesome-public-datasets](https://github.com/awesomedata/awesome-public-datasets) ⭐ 78,878 | 🐛 158 | 📅 2026-09-08 - An awesome repository full of open datasets from an abundance of different categories.  ![GitHub stars](https://img.shields.io/github/stars/awesomedata/awesome-public-datasets?style=social)
* [Public APIs](https://github.com/public-apis-dev/public-apis) ⭐ 9,434 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-09 - A collective list of free APIs for use in software and web development. ![GitHub stars](https://img.shields.io/github/stars/public-apis-dev/public-apis?style=social)
...
* [GeoLibre](https://github.com/opengeos/GeoLibre) ⭐ 7,242 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-09 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data across desktop and web environments, with a responsive layout for mobile screens. ![GitHub stars](https://img.shields.io/github/stars/opengeos/GeoLibre?style=social)
* [Fantasy Map Generator](https://github.com/Azgaar/Fantasy-Map-Generator) ⭐ 5,984 | 🐛 96 | 🌐 HTML | 📅 2026-09-09 - Free web application for creating and editing fantasy maps. ![GitHub stars](https://img.shields.io/github/stars/Azgaar/Fantasy-Map-Generator?style=social)
...
* [Maputnik](https://github.com/maputnik/editor) ⭐ 2,627 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-08 - Free and open visual editor for Mapbox GL styles. ![GitHub stars](https://img.shields.io/github/stars/maputnik/editor?style=social)
* [uMap](https://github.com/umap-project/umap) ⭐ 1,593 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-09 - Create maps with OpenStreetMap layers and embed them in your site. ![GitHub stars](https://img.shields.io/github/stars/umap-project/umap?style=social)
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-09 - Open-source fuel price comparison and EV charging route planner using MapLibre GL JS, PostGIS, Valhalla routing, and Photon geocoding. ![GitHub stars](https://img.shields.io/github/stars/GeiserX/pumperly?style=social)
...
If you have any questions about this list, please don't hesitate to contact me [@joewdavies](https://twitter.com/joewdavies) on X (formerly Twitter) or [open a GitHub issue](https://github.com/joewdavies/awesome-frontend-gis/issues/new) ⭐ 858 | 🐛 8 | 📅 2026-08-18.
